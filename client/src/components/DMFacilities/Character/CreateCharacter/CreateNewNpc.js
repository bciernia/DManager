...
const CreateNewNpc = () => {
    ...
    const addNewCharacterHandler = (character) => {
        ...
        fetch(`http://127.0.0.1:3000/characters/newNpc`, {
            method: "POST",
            headers: {
        ...
        <Box sx={{height: "100%", display: "flex", justifyContent: "center", alignItems: "center"}}>
            ...
            >
                ...
                <FormStep
                    ...
                    <Typography variant="h4" sx={{width: "100%", textAlign: "center", marginBottom: "2rem"}}>New
                        NPC</Typography>
                ...
                <FormStep
                    ...
                    <Typography variant="h4"
                                sx={{width: "100%", textAlign: "center", marginBottom: "2rem"}}>Statistics</Typography>
                ...
                >
                    ...
                    <Typography variant="h4" sx={{width: "100%", textAlign: "center", marginBottom: "2rem"}}>Saving
                        throws</Typography>
                ...
                >
                    ...
                    <Typography variant="h4"
                                sx={{width: "100%", textAlign: "center", marginBottom: "2rem"}}>Skills</Typography>
